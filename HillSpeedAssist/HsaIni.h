...
/**
    hsa.ini input output class.
*/
class HsaIni
{
public:

    HsaIni(string_t fname = _T(""))
    {
        initFileName = _T("./hsa.ini"); //Default file.    
        init();
        load(fname);
    }
...
protected:
    ...
    bool iniRW(string_t f, int r)
    {
        ...
        inimoni::inirw(r, f, s, _T("Key              "), Config.Key);
        return true;
    }
